...
### Step 3: Assemble and Post Comment

Combine all three outputs into a single HTML comment. **Use HTML formatting** (Fizzy renders HTML, not Markdown).
...
<h3>4. Scope Change Summary for PM</h3>
<p>Hey {CREATOR_FIRST_NAME} — here is how and why the scope changed:</p>
...
curl -s -X POST "https://app.fizzy.do/6102589/cards/{NUMBER}/comments.json" \
  ...
  -H "Accept: application/json" \
  -d '{"comment": {"body": "<h2>Ticket Review — Card #...</h2>..."}}'
# 201 = success
```
